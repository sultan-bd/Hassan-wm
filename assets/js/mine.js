...
document
  ...
  .addEventListener("submit", async function (e) {
    ...
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbwAVi7o8MXYiZb8Yz0Imxy_51j3rm6QGlS2SnhbcBoGLkPV3CGF3bbimVBAA1y7H99U/exec"; // Replace with your Web App URL
...
function getSuccessCharacter() {
  return `
    <svg viewBox="0 0 200 200" class="feedback-character">
      ...
      <circle cx="130" cy="60" r="1.5" fill="#ffd700">
...
function getErrorCharacter() {
  return `
    <svg viewBox="0 0 200 200" class="feedback-character">
      ...
      <!-- Arms down -->
      <ellipse cx="85" cy="115" rx="6" ry="12" fill="url(#errorGrad)"/>
      <ellipse cx="115" cy="115" rx="6" ry="12" fill="url(#errorGrad)"/>
    </svg>
  `;
}
...
function getNextNumber() {
  const scriptURL =
    "https://script.google.com/macros/s/AKfycbwAVi7o8MXYiZb8Yz0Imxy_51j3rm6QGlS2SnhbcBoGLkPV3CGF3bbimVBAA1y7H99U/exec"; // Replace with your Apps Script URL
